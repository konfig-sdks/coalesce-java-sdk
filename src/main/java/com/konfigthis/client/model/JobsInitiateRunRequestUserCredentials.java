...
public class JobsInitiateRunRequestUserCredentials {
  ...
  public JobsInitiateRunRequestUserCredentials() {
  }

  public JobsInitiateRunRequestUserCredentials snowflakeUsername(String snowflakeUsername) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakePassword(String snowflakePassword) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakeKeyPairKey(String snowflakeKeyPairKey) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakeKeyPairPass(String snowflakeKeyPairPass) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakeWarehouse(String snowflakeWarehouse) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakeRole(String snowflakeRole) {
  ...
  **/
  ...
  public JobsInitiateRunRequestUserCredentials snowflakeAuthType(String snowflakeAuthType) {
  ...
  **/
   ...
   * @return the JobsInitiateRunRequestUserCredentials instance itself
   */
  public JobsInitiateRunRequestUserCredentials putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    JobsInitiateRunRequestUserCredentials jobsInitiateRunRequestUserCredentials = (JobsInitiateRunRequestUserCredentials) o;
    return Objects.equals(this.snowflakeUsername, jobsInitiateRunRequestUserCredentials.snowflakeUsername) &&
        Objects.equals(this.snowflakePassword, jobsInitiateRunRequestUserCredentials.snowflakePassword) &&
        Objects.equals(this.snowflakeKeyPairKey, jobsInitiateRunRequestUserCredentials.snowflakeKeyPairKey) &&
        Objects.equals(this.snowflakeKeyPairPass, jobsInitiateRunRequestUserCredentials.snowflakeKeyPairPass) &&
        Objects.equals(this.snowflakeWarehouse, jobsInitiateRunRequestUserCredentials.snowflakeWarehouse) &&
        Objects.equals(this.snowflakeRole, jobsInitiateRunRequestUserCredentials.snowflakeRole) &&
        Objects.equals(this.snowflakeAuthType, jobsInitiateRunRequestUserCredentials.snowflakeAuthType)&&
        Objects.equals(this.additionalProperties, jobsInitiateRunRequestUserCredentials.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class JobsInitiateRunRequestUserCredentials {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to JobsInitiateRunRequestUserCredentials
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!JobsInitiateRunRequestUserCredentials.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in JobsInitiateRunRequestUserCredentials is not found in the empty JSON string", JobsInitiateRunRequestUserCredentials.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!JobsInitiateRunRequestUserCredentials.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'JobsInitiateRunRequestUserCredentials' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<JobsInitiateRunRequestUserCredentials> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(JobsInitiateRunRequestUserCredentials.class));

       return (TypeAdapter<T>) new TypeAdapter<JobsInitiateRunRequestUserCredentials>() {
           @Override
           public void write(JsonWriter out, JobsInitiateRunRequestUserCredentials value) throws IOException {
           ...
           @Override
           public JobsInitiateRunRequestUserCredentials read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             JobsInitiateRunRequestUserCredentials instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of JobsInitiateRunRequestUserCredentials given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of JobsInitiateRunRequestUserCredentials
  * @throws IOException if the JSON string is invalid with respect to JobsInitiateRunRequestUserCredentials
  */
  public static JobsInitiateRunRequestUserCredentials fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, JobsInitiateRunRequestUserCredentials.class);
  }

 /**
  * Convert an instance of JobsInitiateRunRequestUserCredentials to an JSON string
  *
  * @return JSON string
  */
