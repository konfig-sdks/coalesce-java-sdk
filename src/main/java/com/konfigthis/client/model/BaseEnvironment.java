 ...
 */
@ApiModel(description = "An environment is used for deploying your data pipeline to non-development Snowflake environments.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class BaseEnvironment {
  ...
  public BaseEnvironment description(String description) {
  ...
  **/
  ...
  public BaseEnvironment connectionAccount(String connectionAccount) {
  ...
  **/
  ...
  public BaseEnvironment defaultStorageMapping(String defaultStorageMapping) {
  ...
  **/
  ...
  public BaseEnvironment name(String name) {
  ...
  **/
  ...
  public BaseEnvironment oauthEnabled(Boolean oauthEnabled) {
  ...
  **/
  ...
  public BaseEnvironment runTimeParameters(Map<String, Object> runTimeParameters) {
  ...
  public BaseEnvironment putRunTimeParametersItem(String key, Object runTimeParametersItem) {
  ...
  **/
  ...
  public BaseEnvironment tagColors(TagColor tagColors) {
  ...
  **/
  ...
  public BaseEnvironment project(String project) {
  ...
  **/
   ...
   * @return the BaseEnvironment instance itself
   */
  public BaseEnvironment putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BaseEnvironment baseEnvironment = (BaseEnvironment) o;
    return Objects.equals(this.description, baseEnvironment.description) &&
        Objects.equals(this.connectionAccount, baseEnvironment.connectionAccount) &&
        Objects.equals(this.defaultStorageMapping, baseEnvironment.defaultStorageMapping) &&
        Objects.equals(this.name, baseEnvironment.name) &&
        Objects.equals(this.oauthEnabled, baseEnvironment.oauthEnabled) &&
        Objects.equals(this.runTimeParameters, baseEnvironment.runTimeParameters) &&
        Objects.equals(this.tagColors, baseEnvironment.tagColors) &&
        Objects.equals(this.project, baseEnvironment.project)&&
        Objects.equals(this.additionalProperties, baseEnvironment.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, connectionAccount, defaultStorageMapping, name, oauthEnabled, runTimeParameters, tagColors, project, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BaseEnvironment {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BaseEnvironment
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BaseEnvironment.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BaseEnvironment is not found in the empty JSON string", BaseEnvironment.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BaseEnvironment.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BaseEnvironment' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BaseEnvironment> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BaseEnvironment.class));

       return (TypeAdapter<T>) new TypeAdapter<BaseEnvironment>() {
           @Override
           public void write(JsonWriter out, BaseEnvironment value) throws IOException {
           ...
           @Override
           public BaseEnvironment read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BaseEnvironment instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BaseEnvironment given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BaseEnvironment
  * @throws IOException if the JSON string is invalid with respect to BaseEnvironment
  */
  public static BaseEnvironment fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BaseEnvironment.class);
  }

 /**
  * Convert an instance of BaseEnvironment to an JSON string
  *
  * @return JSON string
  */
