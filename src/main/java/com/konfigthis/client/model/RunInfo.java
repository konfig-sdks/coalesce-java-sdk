 ...
 */
@ApiModel(description = "The full details of a run, without the run results.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class RunInfo {
  ...
  public RunInfo version(Integer version) {
  ...
  **/
  ...
  public RunInfo reRunID(String reRunID) {
  ...
  **/
  ...
  public RunInfo runDetails(DRRunDetails runDetails) {
  ...
  **/
  ...
  public RunInfo runEndTime(OffsetDateTime runEndTime) {
  ...
  **/
  ...
  public RunInfo runHistory(List<Integer> runHistory) {
  ...
  public RunInfo addRunHistoryItem(Integer runHistoryItem) {
  ...
  **/
  ...
  public RunInfo runStartTime(OffsetDateTime runStartTime) {
  ...
  **/
  ...
  public RunInfo runStatus(RunStatus runStatus) {
  ...
  **/
  ...
  public RunInfo runTimeParameters(Map<String, Object> runTimeParameters) {
  ...
  public RunInfo putRunTimeParametersItem(String key, Object runTimeParametersItem) {
  ...
  **/
  ...
  public RunInfo runType(RunType runType) {
  ...
  **/
  ...
  public RunInfo userCredentials(SnowflakeUserCredentials userCredentials) {
  ...
  **/
  ...
  public RunInfo userID(String userID) {
  ...
  **/
   ...
   * @return the RunInfo instance itself
   */
  public RunInfo putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, runInfo.version) &&
        Objects.equals(this.id, runInfo.id) &&
        Objects.equals(this.reRunID, runInfo.reRunID) &&
        Objects.equals(this.runDetails, runInfo.runDetails) &&
        Objects.equals(this.runEndTime, runInfo.runEndTime) &&
        Objects.equals(this.runHistory, runInfo.runHistory) &&
        Objects.equals(this.runStartTime, runInfo.runStartTime) &&
        Objects.equals(this.runStatus, runInfo.runStatus) &&
        Objects.equals(this.runTimeParameters, runInfo.runTimeParameters) &&
        Objects.equals(this.runType, runInfo.runType) &&
        Objects.equals(this.userCredentials, runInfo.userCredentials) &&
        Objects.equals(this.userID, runInfo.userID)&&
        Objects.equals(this.additionalProperties, runInfo.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, id, reRunID, runDetails, runEndTime, runHistory, runStartTime, runStatus, runTimeParameters, runType, userCredentials, userID, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("runTimeParameters");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RunInfo
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RunInfo.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RunInfo is not found in the empty JSON string", RunInfo.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RunInfo.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RunInfo.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RunInfo' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RunInfo> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RunInfo.class));

       return (TypeAdapter<T>) new TypeAdapter<RunInfo>() {
           @Override
           public void write(JsonWriter out, RunInfo value) throws IOException {
           ...
           @Override
           public RunInfo read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RunInfo instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RunInfo given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RunInfo
  * @throws IOException if the JSON string is invalid with respect to RunInfo
  */
  public static RunInfo fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RunInfo.class);
  }

 /**
  * Convert an instance of RunInfo to an JSON string
  *
  * @return JSON string
  */
