...
public class Error {
  ...
  public Error errorString(String errorString) {
  ...
  **/
  ...
  @ApiModelProperty(value = "Additional detail about the error.")
  ...
  public boolean equals(Object o) {
    ...
    Error error = (Error) o;
    return Objects.equals(this.errorString, error.errorString) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(errorString, errorDetail, additionalProperties);
  }
  ...
  static {
    ...
    openapiRequiredFields.add("errorString");
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("errorString").isJsonPrimitive()) {
