...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://app.coalescesoftware.io";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec0", new ApiKeyAuth("header", "Authorization"));
        ...
        if (configuration != null) {
            if (configuration.sec0 != null) {
                this.setSec0(configuration.sec0);
            }
    ...
    public String getSec0() {
        return ((ApiKeyAuth) this.getAuthentication("sec0")).getApiKey();
    }

    public void setSec0(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("sec0")).setApiKey(apiKey);
    }

    public void setSec0Prefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("sec0")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://app.coalescesoftware.io)
